...
F:G$Calculate_Tmax$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$random$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$LPause$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$MPause$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$SPause$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Hold$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Play$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Bonus$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Light_LEDs$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Check_Flags$0$0({2}DF,SC:S),Z,0,0,0,0,0
F:G$PrintScore$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$PrintWinner$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ResetGame$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llab2.getchar$c$1$10({1}SC:S),R,0,0,[]
S:G$Counts$0$0({2}SI:U),E,0,0
S:G$Player1$0$0({6}DA3d,DA2d,SC:U),E,0,0
S:G$Player2$0$0({6}DA3d,DA2d,SC:U),E,0,0
S:G$PB1_flag$0$0({1}SC:S),E,0,0
S:G$PB2_flag$0$0({1}SC:S),E,0,0
S:G$PB3_flag$0$0({1}SC:S),E,0,0
S:G$check$0$0({1}SC:S),E,0,0
S:G$dodges$0$0({1}SC:U),E,0,0
S:G$hits$0$0({1}SC:U),E,0,0
S:G$prev$0$0({1}SC:U),E,0,0
S:G$num$0$0({1}SC:U),E,0,0
S:G$T1$0$0({2}SI:U),E,0,0
S:G$T2$0$0({2}SI:U),E,0,0
S:G$Rounds$0$0({1}SC:U),E,0,0
S:G$Tmax$0$0({2}SI:S),E,0,0
S:Llab2.Calculate_Tmax$Calc$1$79({2}SI:U),R,0,0,[]
S:Llab2.Play$player$1$90({1}SC:S),E,0,0
S:Llab2.Play$sloc0$1$0({1}SC:S),E,0,0
S:Llab2.Play$sloc1$1$0({4}SF:S),E,0,0
S:Llab2.Light_LEDs$num$1$114({1}SC:S),R,0,0,[r7]
S:Llab2.PrintScore$num$1$131({1}SC:S),E,0,0
S:Llab2.PrintWinner$S1$1$134({1}SC:S),R,0,0,[r7]
S:Llab2.PrintWinner$S2$1$134({1}SC:S),R,0,0,[r6]
...
S:G$BLED00$0$0({1}SX:U),J,0,0
S:G$BLED01$0$0({1}SX:U),J,0,0
S:G$BLED10$0$0({1}SX:U),J,0,0
S:G$BLED11$0$0({1}SX:U),J,0,0
S:G$BZ$0$0({1}SX:U),J,0,0
...
S:Flab2$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:Flab2$__str_1$0$0({18}DA18d,SC:S),D,0,0
S:Flab2$__str_2$0$0({18}DA18d,SC:S),D,0,0
S:Flab2$__str_3$0$0({3}DA3d,SC:S),D,0,0
S:Flab2$__str_4$0$0({17}DA17d,SC:S),D,0,0
S:Flab2$__str_5$0$0({26}DA26d,SC:S),D,0,0
S:Flab2$__str_6$0$0({23}DA23d,SC:S),D,0,0
S:Flab2$__str_7$0$0({35}DA35d,SC:S),D,0,0
S:Flab2$__str_8$0$0({28}DA28d,SC:S),D,0,0
S:Flab2$__str_9$0$0({26}DA26d,SC:S),D,0,0
S:Flab2$__str_10$0$0({26}DA26d,SC:S),D,0,0
