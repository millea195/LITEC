...
F:G$Steering$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Heading_Adjust$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Blimp$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$SetHeadingGain$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$SetFans$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$CalculateBattery$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Display$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$SPause$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LLab6.getchar$c$1$10({1}SC:S),R,0,0,[]
...
S:G$LFAN_PW$0$0({2}SI:U),E,0,0
S:G$RFAN_PW$0$0({2}SI:U),E,0,0
S:G$TURN_PW$0$0({2}SI:U),E,0,0
S:G$MOTOR_PW$0$0({2}SI:U),E,0,0
S:G$TILT_PW$0$0({2}SI:U),E,0,0
S:G$FAN_PW$0$0({2}SI:U),E,0,0
S:G$voltage$0$0({2}SI:U),E,0,0
S:G$heading$0$0({2}SI:U),E,0,0
S:G$D_heading$0$0({2}SI:S),E,0,0
S:G$range$0$0({2}SI:U),E,0,0
S:G$h_shift$0$0({2}SI:S),E,0,0
S:G$c_adjust$0$0({2}SI:S),E,0,0
S:G$prev_c_adj$0$0({2}SI:S),E,0,0
S:G$kP$0$0({2}SI:U),E,0,0
S:G$kD$0$0({2}SI:U),E,0,0
S:G$h_count$0$0({1}SC:U),E,0,0
S:G$p_count$0$0({1}SC:U),E,0,0
S:G$d_count$0$0({1}SC:U),E,0,0
...
S:LLab6.ReadCompass$Data$1$145({2}DA2d,SC:U),E,0,0
S:LLab6.ReadCompass$hdng$1$145({2}SI:U),R,0,0,[]
S:LLab6.Steering$error$1$147({2}SI:S),R,0,0,[r6,r7]
S:LLab6.Steering$G_heading$1$147({2}SI:S),R,0,0,[r4,r5]
S:LLab6.Blimp$tmp_PW1$1$158({2}SI:S),R,0,0,[]
S:LLab6.Blimp$tmp_PW2$1$158({2}SI:S),R,0,0,[]
S:LLab6.Blimp$sloc0$1$0({4}SL:S),E,0,0
S:LLab6.Blimp$sloc1$1$0({4}SL:S),E,0,0
S:LLab6.SetHeadingGain$input$2$165({2}SI:U),R,0,0,[r4,r5]
S:LLab6.SetHeadingGain$sum$2$165({2}SI:U),R,0,0,[r6,r7]
S:LLab6.SetFans$input$1$176({1}SC:S),R,0,0,[r7]
S:LLab6.SetFans$TURN_PW$1$176({2}SI:U),R,0,0,[r5,r6]
...
S:FLab6$__str_3$0$0({9}DA9d,SC:S),D,0,0
S:FLab6$__str_4$0$0({59}DA59d,SC:S),D,0,0
S:FLab6$__str_5$0$0({17}DA17d,SC:S),D,0,0
S:FLab6$__str_6$0$0({26}DA26d,SC:S),D,0,0
S:FLab6$__str_7$0$0({27}DA27d,SC:S),D,0,0
S:FLab6$__str_8$0$0({26}DA26d,SC:S),D,0,0
S:FLab6$__str_9$0$0({3}DA3d,SC:S),D,0,0
S:FLab6$__str_10$0$0({31}DA31d,SC:S),D,0,0
S:FLab6$__str_11$0$0({51}DA51d,SC:S),D,0,0
S:FLab6$__str_12$0$0({23}DA23d,SC:S),D,0,0
S:FLab6$__str_13$0$0({39}DA39d,SC:S),D,0,0
S:FLab6$__str_14$0$0({21}DA21d,SC:S),D,0,0
S:FLab6$__str_15$0$0({27}DA27d,SC:S),D,0,0
S:FLab6$__str_16$0$0({35}DA35d,SC:S),D,0,0
S:FLab6$__str_17$0$0({29}DA29d,SC:S),D,0,0
