...
// sbit Declaration
//---------------------------------------------------------------------------------
__sbit __at 0xB0 Steering_Switch;
__sbit __at 0xB1 Drive_Switch;
__sbit __at 0xB2 Enable_LCD;
__sbit __at 0xB3 Enable_HT;
__sbit __at 0xB4 Heading_Height;
__sbit __at 0xB5 Steering_GD;
__sbit __at 0xB6 Drive_GD;
__sbit __at 0xB7 Drive_Angle;
//---------------------------------------------------------------------------------
// Main Function
//---------------------------------------------------------------------------------
void main(void){
