...
F:G$initialize_motor_and_servo$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$calculate_offset$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Port_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ADC_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$read_AD_input$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$Calculate_Batttery$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
F:G$read_accel$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
F:G$updateLCD$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LLab5.getchar$c$1$10({1}SC:S),R,0,0,[]
S:LLab5.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:LLab5.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:LLab5.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:LLab5.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:LLab5.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:LLab5.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:LLab5.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:LLab5.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:LLab5.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:LLab5.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:LLab5.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:LLab5.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:LLab5.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:LLab5.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:LLab5.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:LLab5.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
S:LLab5.i2c_read_data$addr$1$99({1}SC:U),R,0,0,[r7]
S:LLab5.i2c_read_data$j$1$100({1}SC:U),R,0,0,[]
S:LLab5.Accel_Init$Data2$1$103({1}DA1d,SC:U),E,0,0
...
S:G$gx$0$0({2}SI:U),E,0,0
S:G$gy$0$0({2}SI:U),E,0,0
S:G$ks$0$0({1}SC:U),E,0,0
S:G$kdx$0$0({1}SC:U),E,0,0
S:G$kdy$0$0({1}SC:U),E,0,0
S:G$gx_offset$0$0({2}SI:U),E,0,0
S:G$gy_offset$0$0({2}SI:U),E,0,0
S:LLab5.main$run_stop$1$120({1}SC:U),R,0,0,[r7]
S:LLab5.calculate_offset$calibrate_avg_gx$1$130({2}SI:U),R,0,0,[r6,r7]
S:LLab5.calculate_offset$calibrate_avg_gy$1$130({2}SI:U),E,0,0
S:LLab5.calculate_offset$j$1$130({1}SC:U),R,0,0,[]
S:LLab5.read_accel$i$1$149({1}SC:U),R,0,0,[]
S:LLab5.set_gains$input$1$161({2}SI:S),R,0,0,[r6,r7]
S:LLab5.lcd_print$text$1$73({80}DA80d,SC:U),F,0,0
...
S:FLab5$__str_3$0$0({49}DA49d,SC:S),D,0,0
S:FLab5$__str_4$0$0({27}DA27d,SC:S),D,0,0
S:FLab5$__str_5$0$0({17}DA17d,SC:S),D,0,0
S:FLab5$__str_6$0$0({13}DA13d,SC:S),D,0,0
S:FLab5$__str_7$0$0({13}DA13d,SC:S),D,0,0
S:FLab5$__str_8$0$0({13}DA13d,SC:S),D,0,0
S:FLab5$__str_9$0$0({19}DA19d,SC:S),D,0,0
S:FLab5$__str_10$0$0({19}DA19d,SC:S),D,0,0
S:FLab5$__str_11$0$0({19}DA19d,SC:S),D,0,0
S:FLab5$__str_12$0$0({21}DA21d,SC:S),D,0,0
S:FLab5$__str_13$0$0({15}DA15d,SC:S),D,0,0
S:FLab5$__str_14$0$0({18}DA18d,SC:S),D,0,0
