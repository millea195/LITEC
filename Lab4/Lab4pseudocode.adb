...
S:LLab4pseudocode.lcd_print$fmt$1$72({3}DG,SC:S),B,1,-5
S:LLab4pseudocode.lcd_print$len$1$73({1}SC:U),R,0,0,[r6]
S:LLab4pseudocode.lcd_print$i$1$73({1}SC:U),R,0,0,[]
S:LLab4pseudocode.lcd_print$ap$1$73({1}DD,SC:U),R,0,0,[]
...
F:G$Calibrate$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$StartPing$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ReadRanger$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$ReadCompass$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$Automate_Steering$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$Dodge_Obstacle$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$SetHeadingGain$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Drive$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$CalculateBattery$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LED_Display$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LLab4pseudocode.getchar$c$1$10({1}SC:S),R,0,0,[]
S:LLab4pseudocode.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:LLab4pseudocode.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:LLab4pseudocode.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:LLab4pseudocode.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:LLab4pseudocode.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:LLab4pseudocode.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:LLab4pseudocode.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:LLab4pseudocode.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:LLab4pseudocode.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:LLab4pseudocode.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:LLab4pseudocode.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:LLab4pseudocode.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:LLab4pseudocode.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:LLab4pseudocode.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:LLab4pseudocode.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:LLab4pseudocode.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
S:LLab4pseudocode.i2c_read_data$addr$1$99({1}SC:U),R,0,0,[r7]
S:LLab4pseudocode.i2c_read_data$j$1$100({1}SC:U),R,0,0,[]
S:LLab4pseudocode.Accel_Init$Data2$1$103({1}DA1d,SC:U),E,0,0
S:G$TPW_CENTER$0$0({2}SI:U),E,0,0
S:G$TPW_MIN$0$0({2}SI:U),E,0,0
S:G$TPW_MAX$0$0({2}SI:U),E,0,0
S:G$TURN_PW$0$0({2}SI:U),E,0,0
S:G$MOTOR_PW$0$0({2}SI:U),E,0,0
S:G$voltage$0$0({2}SI:U),E,0,0
S:G$gain$0$0({1}SC:U),E,0,0
S:G$heading$0$0({2}SI:U),E,0,0
S:G$D_heading$0$0({2}SI:U),E,0,0
S:G$range$0$0({2}SI:U),E,0,0
S:G$h_count$0$0({1}SC:U),E,0,0
S:G$p_count$0$0({1}SC:U),E,0,0
S:G$l_count$0$0({1}SC:U),E,0,0
S:G$update_flag$0$0({1}SC:U),E,0,0
S:G$Counts$0$0({2}SI:U),E,0,0
S:G$nCounts$0$0({1}SC:U),E,0,0
S:G$R_Data$0$0({2}DA2d,SC:U),E,0,0
S:G$addr$0$0({1}SC:U),E,0,0
S:LLab4pseudocode.Calibrate$input$1$142({1}SC:S),R,0,0,[r7]
S:LLab4pseudocode.ReadCompass$Data$1$153({2}DA2d,SC:U),E,0,0
S:LLab4pseudocode.ReadCompass$hdng$1$153({2}SI:U),R,0,0,[]
S:LLab4pseudocode.Automate_Steering$error$1$154({2}SI:S),R,0,0,[r6,r7]
S:LLab4pseudocode.Dodge_Obstacle$dodge$1$160({2}SI:U),R,0,0,[r6,r7]
S:LLab4pseudocode.SetHeadingGain$input$2$165({2}SI:S),R,0,0,[r6,r7]
S:LLab4pseudocode.Drive$new_PW$1$181({2}SI:S),R,0,0,[r6,r7]
S:LLab4pseudocode.Drive$c_adjust$1$181({2}SI:S),R,0,0,[r6,r7]
S:LLab4pseudocode.Drive$r_adjust$1$181({2}SI:U),R,0,0,[r4,r5]
S:LLab4pseudocode.lcd_print$text$1$73({80}DA80d,SC:U),F,0,0
...
S:G$Compass_Heading$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:G$read_AD_input$0$0({2}DF,SC:U),C,0,0
S:FLab4pseudocode$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FLab4pseudocode$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FLab4pseudocode$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FLab4pseudocode$__str_3$0$0({9}DA9d,SC:S),D,0,0
S:FLab4pseudocode$__str_4$0$0({18}DA18d,SC:S),D,0,0
S:FLab4pseudocode$__str_5$0$0({9}DA9d,SC:S),D,0,0
S:FLab4pseudocode$__str_6$0$0({25}DA25d,SC:S),D,0,0
S:FLab4pseudocode$__str_7$0$0({40}DA40d,SC:S),D,0,0
S:FLab4pseudocode$__str_8$0$0({38}DA38d,SC:S),D,0,0
S:FLab4pseudocode$__str_9$0$0({42}DA42d,SC:S),D,0,0
S:FLab4pseudocode$__str_10$0$0({41}DA41d,SC:S),D,0,0
S:FLab4pseudocode$__str_11$0$0({36}DA36d,SC:S),D,0,0
S:FLab4pseudocode$__str_12$0$0({44}DA44d,SC:S),D,0,0
S:FLab4pseudocode$__str_13$0$0({36}DA36d,SC:S),D,0,0
S:FLab4pseudocode$__str_14$0$0({43}DA43d,SC:S),D,0,0
S:FLab4pseudocode$__str_15$0$0({16}DA16d,SC:S),D,0,0
S:FLab4pseudocode$__str_16$0$0({15}DA15d,SC:S),D,0,0
S:FLab4pseudocode$__str_17$0$0({15}DA15d,SC:S),D,0,0
S:FLab4pseudocode$__str_18$0$0({15}DA15d,SC:S),D,0,0
S:FLab4pseudocode$__str_19$0$0({13}DA13d,SC:S),D,0,0
S:FLab4pseudocode$__str_20$0$0({16}DA16d,SC:S),D,0,0
S:FLab4pseudocode$__str_21$0$0({16}DA16d,SC:S),D,0,0
S:FLab4pseudocode$__str_22$0$0({14}DA14d,SC:S),D,0,0
S:FLab4pseudocode$__str_23$0$0({12}DA12d,SC:S),D,0,0
S:FLab4pseudocode$__str_24$0$0({9}DA9d,SC:S),D,0,0
S:FLab4pseudocode$__str_25$0$0({15}DA15d,SC:S),D,0,0
S:FLab4pseudocode$__str_26$0$0({14}DA14d,SC:S),D,0,0
S:FLab4pseudocode$__str_27$0$0({15}DA15d,SC:S),D,0,0
S:FLab4pseudocode$__str_28$0$0({13}DA13d,SC:S),D,0,0
S:FLab4pseudocode$__str_29$0$0({13}DA13d,SC:S),D,0,0
S:FLab4pseudocode$__str_30$0$0({10}DA10d,SC:S),D,0,0
S:FLab4pseudocode$__str_31$0$0({3}DA3d,SC:S),D,0,0
