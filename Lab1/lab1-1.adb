...
F:G$sensor3$0$0({2}DF,SI:S),Z,0,0,0,0,0
S:Llab1_1.getchar$c$1$10({1}SC:S),R,0,0,[]
...
S:Flab1_1$__str_2$0$0({23}DA23d,SC:S),D,0,0
S:Flab1_1$__str_3$0$0({18}DA18d,SC:S),D,0,0
S:Flab1_1$__str_4$0$0({18}DA18d,SC:S),D,0,0
