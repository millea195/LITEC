...
; This file was generated Tue Sep 09 15:37:00 2014
;--------------------------------------------------------
	.module lab1_1
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$lab1_1.c$37$1$10 ==.
;	C:\SiLabs\Lab1\lab1-1.c:37: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$lab1_1.c$39$1$31 ==.
;	C:\SiLabs\Lab1\lab1-1.c:39: Sys_Init();        // System Initialization
	lcall	_Sys_Init
	C$lab1_1.c$40$1$31 ==.
;	C:\SiLabs\Lab1\lab1-1.c:40: putchar(' ');      // the quote fonts may not copy correctly into SiLabs IDE
	mov	dpl,#0x20
	lcall	_putchar
	C$lab1_1.c$41$1$31 ==.
;	C:\SiLabs\Lab1\lab1-1.c:41: Port_Init();       // Initialize ports 2 and 3 
	lcall	_Port_Init
	C$lab1_1.c$43$1$31 ==.
;	C:\SiLabs\Lab1\lab1-1.c:43: while (1)          // infinite loop 
00102$:
	C$lab1_1.c$47$2$32 ==.
;	C:\SiLabs\Lab1\lab1-1.c:47: Set_outputs();
	lcall	_Set_outputs
	sjmp	00102$
	C$lab1_1.c$50$1$31 ==.
	XG$main$0$0 ==.
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$lab1_1.c$56$1$31 ==.
;	C:\SiLabs\Lab1\lab1-1.c:56: void Port_Init(void)
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$lab1_1.c$59$1$34 ==.
;	C:\SiLabs\Lab1\lab1-1.c:59: P3MDOUT = P3MDOUT|0xD8 ; // set Port 3 output pins to push-pull mode (fill in the blank)
	orl	_P3MDOUT,#0xD8
	C$lab1_1.c$60$1$34 ==.
;	C:\SiLabs\Lab1\lab1-1.c:60: P3MDOUT = P3MDOUT&0xFC ; // set Port 3 input pins to open drain mode (fill in the blank)
	anl	_P3MDOUT,#0xFC
	C$lab1_1.c$61$1$34 ==.
;	C:\SiLabs\Lab1\lab1-1.c:61: P3 = P3|~0xFC; // set Port 3 input pins to high impedance state (fill in the blank)
	mov	r7,_P3
	mov	a,#0x03
	orl	a,r7
	mov	_P3,a
	C$lab1_1.c$64$1$34 ==.
;	C:\SiLabs\Lab1\lab1-1.c:64: P2MDOUT = P2MDOUT|0x00; // set Port 2 output pins to push-pull mode (fill in the blank)
	mov	_P2MDOUT,_P2MDOUT
	C$lab1_1.c$65$1$34 ==.
;	C:\SiLabs\Lab1\lab1-1.c:65: P2MDOUT = P2MDOUT&0xFE; // set Port 2 input pins to open drain mode (fill in the blank)
	anl	_P2MDOUT,#0xFE
	C$lab1_1.c$66$1$34 ==.
;	C:\SiLabs\Lab1\lab1-1.c:66: P2 = P2|~0xFE; // set Port 2 input pins to high impedance state (fill in the blank)
	mov	r7,_P2
	mov	a,#0x01
	orl	a,r7
	mov	_P2,a
...
;------------------------------------------------------------
	G$Set_outputs$0$0 ==.
	C$lab1_1.c$74$1$34 ==.
;	C:\SiLabs\Lab1\lab1-1.c:74: void Set_outputs(void)
;	-----------------------------------------
;	 function Set_outputs
;	-----------------------------------------
_Set_outputs:
	C$lab1_1.c$77$1$36 ==.
;	C:\SiLabs\Lab1\lab1-1.c:77: if (sensor3())  // if Slide Switch activated 
	lcall	_sensor3
	mov	a,dpl
	mov	b,dph
	orl	a,b
	jz	00118$
	C$lab1_1.c$79$2$37 ==.
;	C:\SiLabs\Lab1\lab1-1.c:79: LED0 = 0;   // Light LED 
	clr	_LED0
	C$lab1_1.c$80$2$37 ==.
;	C:\SiLabs\Lab1\lab1-1.c:80: printf("\rSlide switch is off \n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$lab1_1.c$81$2$37 ==.
;	C:\SiLabs\Lab1\lab1-1.c:81: if (sensor1 || sensor2)
	mov	a,#_sensor1
	orl	a,#(_sensor1 >> 8)
	jnz	00101$
	mov	a,#_sensor2
...
00101$:
	C$lab1_1.c$83$3$38 ==.
;	C:\SiLabs\Lab1\lab1-1.c:83: LED0 = 1;
	setb	_LED0
	C$lab1_1.c$84$3$38 ==.
;	C:\SiLabs\Lab1\lab1-1.c:84: BZ = 1;
	setb	_BZ
	ljmp	00120$
00118$:
	C$lab1_1.c$90$2$39 ==.
;	C:\SiLabs\Lab1\lab1-1.c:90: LED0 = 1;   // turn off LED 
	setb	_LED0
	C$lab1_1.c$91$2$39 ==.
;	C:\SiLabs\Lab1\lab1-1.c:91: printf("\rSlide switch is on \n");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$lab1_1.c$93$2$39 ==.
;	C:\SiLabs\Lab1\lab1-1.c:93: if (sensor1() && sensor2())   //Both PushButtons pushed
	lcall	_sensor1
	mov	a,dpl
	mov	b,dph
	orl	a,b
	...
	jz	00114$
	C$lab1_1.c$95$3$40 ==.
;	C:\SiLabs\Lab1\lab1-1.c:95: BLED1 = 1;
	setb	_BLED1
	C$lab1_1.c$96$3$40 ==.
;	C:\SiLabs\Lab1\lab1-1.c:96: BLED2 =	1;
	setb	_BLED2
	C$lab1_1.c$97$3$40 ==.
;	C:\SiLabs\Lab1\lab1-1.c:97: BZ = 0;
	clr	_BZ
	C$lab1_1.c$98$3$40 ==.
;	C:\SiLabs\Lab1\lab1-1.c:98: printf("\rBoth buttons pushed \n");
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
...
00114$:
	C$lab1_1.c$100$2$39 ==.
;	C:\SiLabs\Lab1\lab1-1.c:100: else if (sensor1())    //PushButton1 Only
	lcall	_sensor1
	mov	a,dpl
	mov	b,dph
	orl	a,b
	jz	00111$
	C$lab1_1.c$102$3$41 ==.
;	C:\SiLabs\Lab1\lab1-1.c:102: BLED1 = 0;
	clr	_BLED1
	C$lab1_1.c$103$3$41 ==.
;	C:\SiLabs\Lab1\lab1-1.c:103: BLED2 = 1; //set voltage to turn BiLED green
	setb	_BLED2
	C$lab1_1.c$104$3$41 ==.
;	C:\SiLabs\Lab1\lab1-1.c:104: BZ = 1;
	setb	_BZ
	C$lab1_1.c$105$3$41 ==.
;	C:\SiLabs\Lab1\lab1-1.c:105: printf("\rButton1 pushed \n");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
...
00111$:
	C$lab1_1.c$108$2$39 ==.
;	C:\SiLabs\Lab1\lab1-1.c:108: else if (sensor2())    //PushButton2 Only
	lcall	_sensor2
	mov	a,dpl
	mov	b,dph
	orl	a,b
	jz	00108$
	C$lab1_1.c$110$3$42 ==.
;	C:\SiLabs\Lab1\lab1-1.c:110: BLED1 = 1;
	setb	_BLED1
	C$lab1_1.c$111$3$42 ==.
;	C:\SiLabs\Lab1\lab1-1.c:111: BLED2 = 0;  //set voltage to turn BiLED red
	clr	_BLED2
	C$lab1_1.c$112$3$42 ==.
;	C:\SiLabs\Lab1\lab1-1.c:112: BZ = 1;
	setb	_BZ
	C$lab1_1.c$113$3$42 ==.
;	C:\SiLabs\Lab1\lab1-1.c:113: printf("\rButton2 pushed \n");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
...
00108$:
	C$lab1_1.c$115$2$39 ==.
;	C:\SiLabs\Lab1\lab1-1.c:115: else if (!(sensor1)||(sensor2))
	mov	a,#_sensor1
	orl	a,#(_sensor1 >> 8)
	jz	00104$
	mov	a,#_sensor2
...
00104$:
	C$lab1_1.c$117$3$43 ==.
;	C:\SiLabs\Lab1\lab1-1.c:117: BLED1 = 1;
	setb	_BLED1
	C$lab1_1.c$118$3$43 ==.
;	C:\SiLabs\Lab1\lab1-1.c:118: BLED2 = 1;
	setb	_BLED2
00120$:
	C$lab1_1.c$121$1$36 ==.
	XG$Set_outputs$0$0 ==.
...
;------------------------------------------------------------
	G$sensor1$0$0 ==.
	C$lab1_1.c$128$1$36 ==.
;	C:\SiLabs\Lab1\lab1-1.c:128: int sensor1(void)
;	-----------------------------------------
;	 function sensor1
;	-----------------------------------------
_sensor1:
	C$lab1_1.c$131$1$45 ==.
;	C:\SiLabs\Lab1\lab1-1.c:131: if (!PB1) return 1;
	jb	_PB1,00102$
	mov	dptr,#0x0001
	sjmp	00104$
00102$:
	C$lab1_1.c$132$1$45 ==.
;	C:\SiLabs\Lab1\lab1-1.c:132: else      return 0;
	mov	dptr,#0x0000
00104$:
	C$lab1_1.c$133$1$45 ==.
	XG$sensor1$0$0 ==.
...
;------------------------------------------------------------
	G$sensor2$0$0 ==.
	C$lab1_1.c$140$1$45 ==.
;	C:\SiLabs\Lab1\lab1-1.c:140: int sensor2(void)
;	-----------------------------------------
;	 function sensor2
;	-----------------------------------------
_sensor2:
	C$lab1_1.c$143$1$47 ==.
;	C:\SiLabs\Lab1\lab1-1.c:143: if (!PB2) return 1;
	jb	_PB2,00102$
	mov	dptr,#0x0001
	sjmp	00104$
00102$:
	C$lab1_1.c$144$1$47 ==.
;	C:\SiLabs\Lab1\lab1-1.c:144: else      return 0;
	mov	dptr,#0x0000
00104$:
	C$lab1_1.c$145$1$47 ==.
	XG$sensor2$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'sensor3'
;------------------------------------------------------------
	G$sensor3$0$0 ==.
	C$lab1_1.c$151$1$47 ==.
;	C:\SiLabs\Lab1\lab1-1.c:151: int sensor3(void)
;	-----------------------------------------
;	 function sensor3
;	-----------------------------------------
_sensor3:
	C$lab1_1.c$154$1$49 ==.
;	C:\SiLabs\Lab1\lab1-1.c:154: if (!SS) return 1;
	jb	_SS,00102$
	mov	dptr,#0x0001
	sjmp	00104$
00102$:
	C$lab1_1.c$155$1$49 ==.
;	C:\SiLabs\Lab1\lab1-1.c:155: else     return 0;
	mov	dptr,#0x0000
00104$:
	C$lab1_1.c$156$1$49 ==.
	XG$sensor3$0$0 ==.
...
___str_3:
	.db 0x0D
	.ascii "Button1 pushed "
	.db 0x0A
	.db 0x00
Flab1_1$__str_4$0$0 == .
___str_4:
	.db 0x0D
	.ascii "Button2 pushed "
	.db 0x0A
	.db 0x00
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
